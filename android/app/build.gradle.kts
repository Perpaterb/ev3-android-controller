...
// Release signing config, read from key.properties (kept out of git). See
// BUILD.md for how to create the keystore and this file.
...
android {
    namespace = "dev.perpaterb.ev3_controller"
